...
| GET Unauthenticated                                                          | returns 200 response: returns a list of all the posts                                                       | ✅ PASS     | [Screenshot](docs/testing/Posts_list_unauth.png)                   |
| GET Authenticated                                                  | returns 200 response: returns a list of all the posts                                       | ✅ PASS     | [Screenshot](docs/testing/Posts_list_auth.png)                     |
| POST Authenticated                                                           | returns 200 response: allows authenticated users to create posts at the bottom of postslist                                          | ✅ PASS     | [Screenshot](docs/testing/Posts_list_createpost_auth.png)                    |
| POST Unauthenticated                                                         | returns 200 response: the create post field is hidden at the bottom of postslist                                                                                           | ✅ PASS     | [Screenshot](docs/testing/Posts_list_createpost_unauth.png)                  |
| PUT, DELETE                                                                  | Not provided                                                                                                | ✅ PASS     |
| _[Post Details](https://sourdoughcircle-api-382dc0f20c45.herokuapp.com/posts/)_                  |                                                                                                             |             |
| GET Unauthenticated                                                          | returns the post specified by id                                                                            | ✅ PASS     | [Screenshot](docs/)            |
| GET Authenticated                                                            | returns the post specified by id                                                                            | ✅ PASS     | [Screenshot](docs/)              |
| PUT Authenticated Owner                                                      | allows the owner to update the post                                                                         | ✅ PASS     | [Screenshot](docs/)        |
| PUT Authenticated Not Owner                                                  | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)    |
| PUT Unauthenticated                                                          | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)            |
| DELETE Authenticated Owner                                                   | returns 204 response: post is deleted                                                                       | ✅ PASS     | [Screenshot](docs/)     |
| DELETE Authenticated Not Owner                                               | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/) |
| DELETE Unauthenticated                                                       | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)         |
| POST                                                                         | Not provided                                                                                                | ✅ PASS     |
| _[Post Like](https://)_              |                                                                                                             |             |
| GET Unauthenticated                                                          | returns a list of profiles that liked the specified post                                                    | ✅ PASS     | [Screenshot](docs/)             |
| GET Authenticated                                                            | returns a list of profiles that liked the specified post                                                    | ✅ PASS     | [Screenshot](docs/)               |
| POST Authenticated                                                           | returns 201 or 204 response: allows authenticated users to like the specified post                          | ✅ PASS     | [Screenshot](docs/)              |
| POST Unauthenticated                                                         | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)            |
| PUT, DELETE                                                                  | Not provided                                                                                                | ✅ PASS     |
**Category**
| _[Category](https://)_ |                                                                                                             |             |
| GET Unauthenticated                                                          | returns a list of posts containing keywords                                                                 | ✅ PASS     | [Screenshot](docs/)            |
| GET Authenticated                                                            | returns a list of posts containing keywords                                                                 | ✅ PASS     | [Screenshot](docs/)              |
| GET Empty Keywords                                                           | returns 400 Bad Request error                                                                               | ✅ PASS     | [Screenshot](docs/)        |
| POST, PUT, DELETE                                                            | Not provided                                                                                                | ✅ PASS     |
| _[Category details](https://)_    |                                                                                                             |             |
| GET Unauthenticated                                                          | returns all the post from the specified profile                                                             | ✅ PASS     | [Screenshot](docs/)          |
| GET Authenticated                                                            | returns all the post from the specified profile                                                             | ✅ PASS     | [Screenshot](docs/)            |
| POST, PUT, DELETE                                                            | Not provided                                                                                                | ✅ PASS     |
**Followers**
| _[Followers list](https://)_           |                                                                                                             |             |
| GET Authenticated                                                            | allows authenticated users to retrieve a list of all the post from the profiles they follow                 | ✅ PASS     | [Screenshot](docs/)              |
| GET Unauthenticated                                                          | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)            |
| POST, PUT, DELETE                                                            | Not provided                                                                                                | ✅ PASS     |
| _[Follower details](https://)_           |                                                                                                             |             |
| GET Authenticated                                                            | allows authenticated users to retrieve a list of all the post they liked                                    | ✅ PASS     | [Screenshot](docs/)               |
| GET Unauthenticated                                                          | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)             |
| POST, PUT, DELETE                                                            | Not provided                                                                                                | ✅ PASS     |
| **Comments**                                                                 |                                                                                                             |             |                                                                          |
| _[Comment List](https://)_        |                                                                                                             |             |
| GET Unauthenticated                                                          | returns a list of all the comments from a specified post                                                    | ✅ PASS     | [Screenshot](docs/)                |
| GET Authenticated                                                            | returns a list of all the comments from a specified post                                                    | ✅ PASS     | [Screenshot](docs/)                  |
| POST Authenticated                                                           | returns 201 response: allows authenticated users to create comments                                         | ✅ PASS     | [Screenshot](docs/)                 |
| POST Unauthenticated                                                         | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)               |
| PUT, DELETE                                                                  | Not provided                                                                                                | ✅ PASS     |
| _[Comment Detail](https://)_   |                                                                                                             |             |
| GET Unauthenticated                                                          | returns the comment specified by id                                                                         | ✅ PASS     | [Screenshot](docs/)         |
| GET Authenticated                                                            | returns the comment specified by id                                                                         | ✅ PASS     | [Screenshot](docs/)           |
| PUT Authenticated Owner                                                      | allows the owner to update the comment                                                                      | ✅ PASS     | [Screenshot](docs/)     |
| PUT Authenticated Not Owner                                                  | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/) |
| PUT Unauthenticated                                                          | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)         |
| DELETE Authenticated Owner                                                   | returns 204 response, comment is deleted                                                                    | ✅ PASS     | [Screenshot](docs/)  |
| DELETE Authenticated Not Owner                                               | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/) |
| DELETE Unauthenticated                                                       | returns 403 error                                                                                           | ✅ PASS     | [Screenshot](docs/)         |
| POST                                                                         | Not provided                                                                                                | ✅ PASS     |
**Likes**                                                                 |                                                                                                             |             |                                                                          |
